...
void MainWindow::afficher_tabClient()
{
...
void MainWindow::afficher_tab_carteFid()
{
...
void MainWindow::on_button_ajouterClient_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}


void MainWindow::on_validerAjout_accepted()
{
...
void MainWindow::on_validerModif_accepted()
{
...
void MainWindow::on_tabClient_activated()
{
...
void MainWindow::on_validerAjout_rejected()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void MainWindow::on_validerModif_rejected()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void MainWindow::on_button_supprimerClient_clicked()
{
    Client c;
...
void MainWindow::on_button_ajouter_carteFid_clicked()
{
...
void MainWindow::on_validerAjout_cf_accepted()
{
...
void MainWindow::on_le_recherche_carteFid_textChanged(const QString &arg1)
{
...
void MainWindow::on_tabCarteFid_clicked(const QModelIndex &index)
{
    carteSelectionne=ui->tabCarteFid->model()->data(index.sibling(index.row(),0)).toInt();
}

void MainWindow::on_tabCarteFid_activated()
{
...
void MainWindow::on_button_supprimer_carteFid_clicked()
{
    CarteFidelite cf;
...
void MainWindow::on_validerAjout_cf_rejected()
{
     ui->stackedWidget_2->setCurrentIndex(0);
}

void MainWindow::on_validerModif_cf_rejected()
{
     ui->stackedWidget_2->setCurrentIndex(0);
}
...
void MainWindow::on_validerModif_cf_accepted()
{
