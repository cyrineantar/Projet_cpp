...
espaceEmploye::espaceEmploye(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::espaceEmploye)
{
    ui->setupUi(this);
...
void espaceEmploye::remplir_cb_employID()
{
...
void espaceEmploye::on_Ajouter_clicked()
{
    clickSound->play();
      ...
      QString Fonction=ui->lineEdit_fonction->currentText();
      int Salaire=ui->lineEdit_salaire->text().toInt();
      QString Etat_civil=ui->lineEdit_Etatcivil->currentText();
      QString Nationalite=ui->lineEdit_nationalite->currentText();
...
if (        ui->lineEdit_ID->text()!= "" &&
        ...
        ui->lineEdit_fonction->currentText()!= "" &&
        ui->lineEdit_salaire->text()!= "" &&
        ui->lineEdit_Etatcivil->currentText()!="" &&
        ui->lineEdit_nationalite->currentText() != "" )
{
    if (!verifier)
        ...
        Employe E(ID,Nom,Prenom,Courriel,Num_tel,Date_n,Adresse,Fonction,Salaire,Etat_civil,Nationalite);
              ...
              bool test=E.ajouter();
               ...
               if (test)
               {
                   ...
                   remplir_cb_employID();
                   QMessageBox::information(nullptr, QObject::tr("Ajouter employé"),
...
void espaceEmploye::on_Modifier_clicked()
{
    clickSound->play();
         int ID=ui->lineEdit_ID->text().toInt();
         QString Nom=ui->lineEdit_nom->text();
...
void espaceEmploye::on_tableView_clicked(const QModelIndex &index)
{
    ...
    QSqlQuery qry;
        ...
        if(qry.exec())
        {
            while(qry.next())
            {
                ...
                ui->lineEdit_fonction->setCurrentText(qry.value(7).toString());
                ui->lineEdit_salaire->setText(qry.value(8).toString());
                ui->lineEdit_Etatcivil->setCurrentText(qry.value(9).toString());
                ui->lineEdit_nationalite->setCurrentText(qry.value(10).toString());


            }
        }
}
void espaceEmploye::on_Supprimer_clicked()
{
    clickSound->play();
    Employe E1;
...
void espaceEmploye::on_Tri_clicked()
{
    clickSound->play();
    Employe E;
...
void espaceEmploye::on_Pdf_clicked()
{
    clickSound->play();
    QString strStream;
...
void espaceEmploye::on_Imprimer_clicked()
{
    clickSound->play();
    QPrinter printer;
...
void espaceEmploye::on_Quitter_clicked()
{
    clickSound->play();
    close();
}
...
void espaceEmploye::on_Ajouter_conge_clicked()
{
    clickSound->play();
...
void espaceEmploye::on_tableView_2_clicked(const QModelIndex &index)
{
...
void espaceEmploye::on_Supprimer_conge_clicked()
{
    clickSound->play();
    conge C1;
...
void espaceEmploye::on_Tri_conge_clicked()
{
    clickSound->play();
    QMessageBox msgBox ;
...
void espaceEmploye::on_Modifier_conge_clicked()
{
    clickSound->play();
    int ID_conge=ui->lineEdit_id_conge->text().toInt();
...
void espaceEmploye::on_Pdf_conge_clicked()
{
    clickSound->play();
    QString strStream;
                 QTextStream out(&strStream);
...
void espaceEmploye::on_Imprimer_conge_clicked()
{
    clickSound->play();
    QPrinter printer;
...
void espaceEmploye::on_Quitter_2_clicked()
{
    clickSound->play();
    close();
}
...
void espaceEmploye::on_Rechercher_clicked()
{
    clickSound->play();
        Employe E;
        if (ui->comboBox_recherche->currentText()=="Adresse")
        {
            QString adresse=ui->le_rech->text();
            if (E.recherche_adresse(adresse))
            {
                ui->tableView->setModel(E.afficher_adresse(adresse));
            }
        }
...
void espaceEmploye::on_Rechercher_conge_clicked()
{
    clickSound->play();
    conge C;
...
void espaceEmploye::on_b_chat_2_clicked()
{
    chat_employe *w =new chat_employe(this);
            w->show();
           chat_server *s  =new chat_server(this);
           s->show();
}
